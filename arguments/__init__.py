...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # self.semantic_until_iter = 150000
        self.semantic_until_iter = 150000
        # self.semantic_until_iter = 0
        self.densify_grad_threshold = 0.001
        # self.densify_grad_threshold = 0.0002
        self.random_background = False
        self.lambda_scale_flatten = 0.
        self.lambda_occ = 0.05
        self.lambda_opacity_entropy = 0.05
        self.art_R_quaternion_lr = 0.01
        self.art_T_lr = 0.01
        self.w_articulation_lr = 0.02
        self.hard_training_step = 30000
        # self.hard_training_step = 30000
        # self.hard_training_step = 7000
